package com.betterda.mylibrary.wheel.widget;
...
import com.betterda.mylibrary.wheel.widget.views.OnWheelChangedListener;
...
public class ChangeAddressDialog extends Dialog implements android.view.View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strProvince = context.getResources().getString(R.string.provice);
        strCity = context.getResources().getString(R.string.city);
    ...
    public void initCitys(String[] citys) {
        if (citys != null) {
            ...
            String[] city = mCitisDatasMap.get(context.getResources().getString(R.string.provice));
            arrCitys.clear();
